...
class SatAppTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.satellite1 = Satellite.objects.create(id=1,
                                                   name="Hubble",
                                                   owner=self.owner1)

        self.satellite2 = Satellite.objects.create(id=2,
                                                   name="YAM6",
                                                   owner=self.owner2)
        ...
        self.launcher1 = Launcher.objects.create(launcher_type="Falcon 9",
    ...
    def test_update_satellite_mutation(self):
        ...
        self.assertEqual(sat['name'], 'Updated Hubble')
